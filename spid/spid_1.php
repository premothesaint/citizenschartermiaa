...
<head>
    ...
    <title>SYSTEMS AND PROCEDURES IMPROVEMENT DIVISION
    - Internal</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>SYSTEMS AND PROCEDURES IMPROVEMENT DIVISION
        (Internal Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/table-images/spid/1.png" alt="">
        </div>
    </div>
