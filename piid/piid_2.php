...
<head>
    ...
    <title>POLICE INTELLIGENCE AND INVESTIGATION DIVISION
    - External</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>POLICE INTELLIGENCE AND INVESTIGATION DIVISION
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/table-images/piid/2.png" alt="">
        </div>
    </div>
