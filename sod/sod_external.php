...
<div class="inactivity-warning" id="inactivityWarning">
  ...
  <div class="glass-overlay">
    <div class="header-container">
      <h1>SURVEILLANCE OPERATIONS DIVISION</h1>
      <h2>EXTERNAL</h2>
    </div>
    <div class="options-container">
      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/sod/1.png">
        </div>
        <a href="../sod/sod_1.php" class="option-button">Approval for CCTV Viewing Request</a>
      </div>
      
      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/sod/2.png">
        </div>
        <a href="../sod/sod_2.php" class="option-button">Approval of Captured Video Footage (CVF) Copy Request</a>
      </div>

      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/sod/3.png">
        </div>
        <a href="../sod/sod_3.php" class="option-button">Approval of Captured Video Footage (CVF) Copy Request for Complex Cases</a>
      </div>
