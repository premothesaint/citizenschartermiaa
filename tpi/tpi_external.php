...
<head>
    ...
    <title>TERMINAL POLICE DIVISION/POLICE INTELLIGENCE AND INVESTIGATION DIVISION - External</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>TERMINAL POLICE DIVISION/POLICE INTELLIGENCE AND INVESTIGATION DIVISION (External Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/tables/tpi.png" alt="Contract Preparation Process">
        </div>
    </div>
