...
<div class="inactivity-warning" id="inactivityWarning">
  ...
  <div class="glass-overlay">
    <div class="header-container">
      <h1>POLICE INTELLIGENCE AND INVESTIGATION DIVISION</h1>
      <h2>EXTERNAL</h2>
    </div>
    <div class="options-container">
      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/piid/1.png">
        </div>
        <a href="../piid/piid_1.php" class="option-button">Issuance of Certificate of Detention</a>
      </div>
      
      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/piid/2.png">
        </div>
        <a href="../piid/piid_2.php" class="option-button">Issuance of Incident Certificate</a>
      </div>

      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/piid/3.png">
        </div>
        <a href="../piid/piid_3.php" class="option-button">Request for Issuance of Police Report</a>
      </div>
