  ...
  <div class="glass-overlay">
    ...
    <div class="options-container">
      <div class="option-box">
        ...
        <img src="../images/button-images/procurement/1.png">
        </div>
        <a href="../procurement/procurement_external1.php" class="option-button">Procurement of Goods and Services</a>
      </div>
      
      <div class="option-box">
        <div class="option-image">
        <img src="../images/button-images/procurement/2.png">
        </div>
        <a href="../procurement/procurement_external2.php" class="option-button">Accreditation of Suppliers/Contractors</a>
      </div>
    </div>
