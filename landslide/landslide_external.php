...
<head>
    ...
    <title>LANDSIDE POLICE DIVISION - External</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>LANDSIDE POLICE DIVISION (External Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/tables/lpd.png" alt="Contract Preparation Process">
        </div>
    </div>
