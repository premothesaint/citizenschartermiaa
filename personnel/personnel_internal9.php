...
<head>
    ...
    <title>PERSONNEL DIVISION - INTERNAL</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>PERSONNEL DIVISION (Internal Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/table-images/personnel/internal/9.png" alt="Contract Preparation Process">
        </div>
    </div>
