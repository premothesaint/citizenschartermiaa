...
<head>
    ...
    <title>PERSONNEL DIVISION - External</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>PERSONNEL DIVISION (External Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/tables/personnel_external.png" alt="Contract Preparation Process">
        </div>
    </div>
