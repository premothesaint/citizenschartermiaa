...
<head>
    ...
    <title>TERMINAL POLICE DIVISION/ AIRSIDE POLICE DIVISION/ LANDSIDE POLICE DIVISION/ 
    POLICE INTELLIGENCE AND INVESTIGATION DIVISION - External</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <div>TERMINAL POLICE DIVISION/AIRSIDE POLICE DIVISION/LANDSIDE POLICE DIVISION/POLICE INTELLIGENCE AND INVESTIGATION DIVISION (External Services)</div>
    ...
    <div class="content">
        <div class="image-container" id="imageContainer">
            <img id="zoomImage" src="../images/tables/talpi.png" alt="Contract Preparation Process">
        </div>
    </div>
